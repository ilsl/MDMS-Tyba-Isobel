    ...
    <div class="col-md-4">
        ...
        <form id="Form1"
            ...
            <asp:GridView ID="usersCurrentChats" runat="server" AllowSorting="False" CssClass="mGrid"
                ...
                DataSourceID="usersCurrentChats_SqlDataSource" OnRowDataBound="usersCurrentChats_OnRowDataBound"
                OnSelectedIndexChanged="usersCurrentChats_OnSelectedIndexChanged">
            </asp:GridView>
    ...
    <div class="col-md-8">
        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#message" aria-controls="message"
                    role="tab" data-toggle="tab"><i class="fa fa-comments"></i>Messages</a></li>
                <li role="presentation"><a href="#files" aria-controls="files" role="tab" data-toggle="tab">
                    <i class="fa fa-file"></i>Files</a></li>
            </ul>
            <!-- Tab content panels -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:GridView ID="allCases_GridView" runat="server" CellSpacing="10" BackColor="White"
                        BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowDataBound="usersCurrentChats_OnRowDataBound"
                        OnSelectedIndexChanged="usersCurrentChats_OnSelectedIndexChanged">
